...
public class ReadingFragment
    ...
    private TextView readingBand;

    private EditText readingScore;

    private RadioGroup readingType;


    private Button calculateReading;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater
                .inflate(R.layout.fragment_reading,
                        container,
                        false);
    ...
    private void initializeViews(View v) {
        ...
        readingBand = v.findViewById(R.id.reading_band);

        readingScore = v.findViewById(R.id.reading_score);

        readingType = v.findViewById(R.id.reading_type);

        calculateReading = v.findViewById(R.id.calculate_reading);
